          ...
          <div style="position:absolute;top:610px;left:0;right:0;text-align:center;line-height:normal;font-size:initial;">
            <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;display:inline-table;"><tr>
              <td style="background:rgba(255,255,255,0.15);border:2px solid rgba(255,255,255,0.85)!important;border-radius:100px;">
                <a href="${copy.ctaUrl||'#'}" style="display:inline-block;padding:14px 44px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;color:#fff!important;-webkit-text-fill-color:#ffffff;text-decoration:none!important;letter-spacing:.03em;white-space:nowrap;">${copy.ctaText}</a>
              </td>
            </tr></table>
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  table{border-collapse:collapse;}
  @media (prefers-color-scheme:dark){
    .btn-text { color:#878787!important; -webkit-text-fill-color:#878787!important; }
  }
  u + .body .btn-text { color:#878787!important; -webkit-text-fill-color:#878787!important; }
</style>
...
<tr><td align="center" style="padding:32px 0;background-color:#ffffff;">
  <table width="600" cellpadding="0" cellspacing="0" bgcolor="${pageBg}" style="width:600px;max-width:600px;${BG};border-radius:20px;overflow:hidden;">
    ...
    <tr><td style="padding:24px 48px 8px;text-align:center;${BG};">
      <table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;"><tr>
        <td style="background:${accent};border-radius:999px;">
          <a href="${copy.ctaUrl||'#'}" style="display:inline-block;padding:15px 40px;font-family:Arial,sans-serif;font-size:17px;font-weight:700;letter-spacing:.04em;color:#878787!important;-webkit-text-fill-color:#878787;text-decoration:none!important;"><span class="btn-text" style="color:#878787!important;-webkit-text-fill-color:#878787;"><font color="#878787">${copy.ctaText} &rarr;</font></span></a>
        </td>
      </tr></table>
    </td></tr>` : ''}
    ...
    <tr><td style="padding:24px 48px 44px;text-align:center;${BG};">
      <table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;"><tr>
        <td style="background:${accent};border-radius:999px;">
          <a href="${copy.ctaUrl||'#'}" style="display:inline-block;padding:15px 40px;font-family:Arial,sans-serif;font-size:17px;font-weight:700;letter-spacing:.04em;color:#878787!important;-webkit-text-fill-color:#878787;text-decoration:none!important;"><span class="btn-text" style="color:#878787!important;-webkit-text-fill-color:#878787;">${copy.ctaText} &rarr;</span></a>
        </td>
      </tr></table>
    </td></tr>` : ''}
