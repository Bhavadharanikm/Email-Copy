...
<tr><td class="gmailfix" style="${WHITE_BG};">
  ...
  ${isHeroGenerated
    ...
    ${heroImg
      ...
      : `<div style="width:100%;height:680px;background:#f0c8b8;border-radius:999px 999px 0 0;text-align:center;color:${accentClr};font-size:12px;font-family:Arial,sans-serif;line-height:680px;">Hero image</div>`}
...
<tr><td style="background-color:${pageBg};">
  ...
  ${copy.ctaText ? `<div class="w2-section" style="padding:24px 48px 28px;text-align:center;background-color:${pageBg};">${btnImgUrl
    ? `<a href="${copy.ctaUrl||'#'}" style="display:block;text-decoration:none;outline:none;border:none;"><img src="${btnImgUrl}" alt="${copy.ctaText}" width="400" style="width:400px;max-width:400px;display:block;margin:0 auto;border:0;outline:none;"/></a>`
  ...
  <!-- BODY BLOCK -->
  ${copy.bodyText ? `<div class="w2-section" style="padding:24px 48px 32px;background-color:${pageBg};"><div class="mobile-body" style="font-size:16px;line-height:1.8;color:${mutedTextCol};margin-bottom:18px;font-family:Arial,sans-serif;">${body}</div></div>` : ''}
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  table{border-collapse:collapse;}
  @media only screen and (max-width:600px){
    .mobile-body    { font-size:18px!important; line-height:1.6!important; }
    .mobile-subhead { font-size:18px!important; line-height:1.5!important; }
    .mobile-b2title { font-size:18px!important; }
    .mobile-closing { font-size:18px!important; line-height:1.6!important; }
    .mobile-cta     { font-size:17px!important; padding:16px 32px!important; }
...
/* ─────────────────────────── Week 5 v2 ─────────────────────────────────── */
function buildTemplateWeek5v3({ client, copy, images, footerData, isHeroGenerated = false,
  heroScale=1, heroX=0, heroY=0,
  textSize=52, textTop=32, textLeft=36,
  logoColor='white', logoTop=28, logoRight=36, logoSize=40,
  img1Scale=1, img1X=0, img1Y=0,
...
<table width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="${pageBg}" style="width:600px;max-width:600px;margin:0 auto;background-color:${pageBg};border-collapse:collapse;border-radius:20px;overflow:hidden;">
    ...
    <tr><td style="padding:20px 52px 8px;text-align:center;background-color:${pageBg};">
      ${btnImgUrl
        ? `<a href="${copy.ctaUrl||'#'}" style="display:block;text-decoration:none;outline:none;border:none;"><img src="${btnImgUrl}" alt="${copy.ctaText}" width="350" style="width:350px;max-width:350px;display:block;margin:0 auto;border:0;outline:none;"/></a>`
        : `<table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;"><tr><td style="background:${accent};border-radius:999px;"><a class="mobile-cta" href="${copy.ctaUrl||'#'}" style="display:inline-block;padding:15px 40px;font-family:Arial,sans-serif;font-size:17px;font-weight:700;letter-spacing:.04em;color:#ffffff!important;-webkit-text-fill-color:#ffffff;text-decoration:none!important;white-space:nowrap;">${copy.ctaText} &rarr;</a></td></tr></table>`}
    </td></tr>` : ''}
...
const TEMPLATES = [
  ...
  { id:18, label:'🔴 Week 5 v2', build:buildTemplateWeek5v3 },
...
<div class="wrap">
  ...
  useEffect(() => {
    ...
    const isWeek5 = tpl?.id === 13 || tpl?.id === 18
...
<div style="width:600px;text-align:center;">
  <div style="display:inline-block;background:${w3v2AccentColor};border-radius:999px;padding:20px 80px;">
    <span style="font-family:Arial,sans-serif;font-size:22px;font-weight:700;letter-spacing:.04em;color:#ffffff;white-space:nowrap;display:inline-flex;align-items:center;gap:10px;">${w3v2CtaText}<span style="display:inline-flex;align-items:center;gap:0;"><span style="display:inline-block;width:12px;height:2px;background:#ffffff;vertical-align:middle;"></span><span style="display:inline-block;width:0;height:0;border-top:5px solid transparent;border-bottom:5px solid transparent;border-left:7px solid #ffffff;vertical-align:middle;"></span></span></span>
  </div>
</div>
</body></html>` : null
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;background:transparent;">
  <tr>
    ...
    const heroHeight = isWeek2 ? 580 : isWeek2v2 ? (logoTop + logoSize + 18 + 680) : (isWeek3 || isWeek3v2) ? 600 : isWeek4 ? 740 : isWeek5 ? 720 : isWeek6 ? 820 : 400
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14, maxWidth: 860, margin: '0 auto' }}>
      ...
      {isEditable && (
        ...
        <div style={{
          ...
          {[10, 11, 13, 14, 16, 17].includes(tpl?.id) && [
