...
// Pass dbId to update the row a previous push created. Without one, `week`
// identifies the row instead: the server upserts on (client_id, week), so
// re-running a week overwrites it rather than adding a second row.
